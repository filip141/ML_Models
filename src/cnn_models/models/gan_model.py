...
if __name__ == '__main__':
    ...
    gan = GANNetwork(generator_input_size=[1024, ], discriminator_input_size=[32, 32, 1],
                     log_path="/home/filip/tensor_logs")
    gan.build_model(0.001, 0.00001)
    gan.train(mnist, 2, 32, epochs=300, sample_per_epoch=1875)
