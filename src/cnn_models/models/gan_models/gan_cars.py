...
if __name__ == '__main__':
    from cnn_models.iterators.cars import CarsDataset

    tf.set_random_seed(100)
    train_path = "/home/filip141/Datasets/Cars/cars_train"
    cars_db = CarsDataset(data_path=train_path, resolution="64x64")
    gan = GANNetwork(generator_input_size=100, discriminator_input_size=[64, 64, 3],
                     log_path="/home/filip141/tensor_logs/GAN_Cars", batch_size=64)
