...
if __name__ == '__main__':
    ...
    gan = WGANNetwork(generator_input_size=100, discriminator_input_size=[64, 64, 3],
                      log_path="/home/filip/tensor_logs/GAN_CelebA", batch_size=64)
    gan.set_discriminator_optimizer("Adam", beta_1=0.5)
    gan.set_generator_optimizer("Adam", beta_1=0.5)
    gan.model_compile(generator_learning_rate=0.00005, discriminator_learning_rate=0.00005)
    gan.train(celeba, train_step=64, epochs=300, sample_per_epoch=1000, restore_model=False, generator_steps=5)
